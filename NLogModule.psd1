...
FunctionsToExport = 
               'Get-LogMessageLayout Get-NewLogConfig Get-NewLogger Get-NewLogTarget Get-NLogDllLoadState Register-NLog UnRegister-NLog Write-Debug Write-Error Write-Host Write-Output Write-Verbose Write-Warning'
